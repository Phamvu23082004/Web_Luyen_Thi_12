...
- **Primary Action:** Blue (#3B82F6) is reserved exclusively for primary actions, active navigation states, and progress indicators.
...
- **Multiple Choice Controls:** Large, clickable tap targets for mobile. Use a 1px border that turns Blue (#3B82F6) when selected. Correct/Incorrect feedback should fill the background with 10% semantic color and change the border to 100% semantic color.
